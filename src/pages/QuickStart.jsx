          ...
          <div className="mx-auto max-w-4xl divide-y divide-gray-900/10">
            ...
            <dl className="mt-10 space-y-6 divide-y divide-gray-900/10">
                ...
                <dt>
                  <DisclosureButton className="group flex w-full items-start justify-between text-left text-gray-900">
                    <span className="text-base/7 font-semibold">
                      Download the Predictaf Mobile app
                    </span>
              ...
              <Disclosure key="register" as="div" className="pt-6">
                ...
                <DisclosurePanel as="dd" className="mt-2 pr-12">
                  <p>
                    A client serves as an umbrella that all facilities will be
                  ...
                  <p className="mt-3">
                    ...
                    support@predictaf.com requesting account verification.
                  ...
                  <p className="mt-3">
                    ...
                    access. Using the Predictaf AppManager website you can:
